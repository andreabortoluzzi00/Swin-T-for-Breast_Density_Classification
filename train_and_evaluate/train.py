...
# CHECKPOINT DIRS
# -------------------------------
checkpoint_dir = os.path.join("./checkpoints", f"{args.dataset}_{args.view_mode}_{args.img_size}_{args.view_type}_{args.window_size}_test__latest")
os.makedirs(checkpoint_dir, exist_ok=True)
checkpoint_latest_path = os.path.join(checkpoint_dir, "latest.pth.tar")

checkpoint_best_dir = os.path.join("./checkpoints", f"{args.dataset}_{args.view_mode}_{args.img_size}_{args.view_type}_{args.window_size}_test__best")
